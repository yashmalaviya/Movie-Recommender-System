...
<<<<<<< HEAD
    try:
        response = session.get(
            ...
            params={
                'api_key': 'cf3fe49dc9569451b004e583333b63ae',
                'language': 'en-US'
            },
...
||||||| 86e8201
    response = requests.get(f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=cf3fe49dc9569451b004e583333b63ae&language=en-US")
    data = response.json()
=======
